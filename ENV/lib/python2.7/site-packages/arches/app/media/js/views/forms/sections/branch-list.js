define(['jquery', 
    ...
    'knockout', 
    'knockout-mapping', 
    'underscore','select2',], function ($, Backbone, ko, koMapping, _, select2) {
    return Backbone.View.extend({

        events: {
            'click .add-button': 'addItem',
            'click [name="discard-edit-link"]': 'undoCurrentEdit',
            'click #add-field-group-btn': 'addFieldGroup'
        },
        ...
        initialize: function(options) {
            ...
            this.fieldGroup = ko.observable(1);
            
            ko.applyBindings(this, this.el);
        },

        addFieldGroup: function () {
            this.fieldGroup(this.fieldGroup() + 1);
        },
        ...
        addItemmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm: function() {
        ...
        // addFieldGroup: function (e,q) {
        //     console.log("addFieldGroup");
        //     $( "#field-group-template" ).clone()
        //         .removeClass("hidden")
        //         .removeAttr('id')
        //         .appendTo( "#field-group-list" );
        // },
                ...
                read: function() {
                    ...
                    _.each(list.nodes(), function(node){
                        if (!Array.isArray(node)) {
                            ...
                            //     if (entitytypeid.search(n.entitytypeid()) > -1){
                            //         ret = n[key]();
                            //     }
                            // })
                        }
                    ...
                    // console.log("getEditedNode read", entitytypeid, key, ret);
                    return ret
                },
                write: function(value){
                    _.each(this.viewModel.branch_lists(), function(list){
                        if(list.editing()){
                            ...
                            // console.log("getEditedNode write ", list);
                        }
                    }, this);
                },
                owner: this
        ...
        getEditedNodeGroup: function(entitytypeid, key, index){
            console.log("getEditedNodeGroup", entitytypeid, key, index);
            this.addDefaultNode(entitytypeid, key, '');
            return ko.pureComputed({
                read: function() {
                    console.log("read:::::::: getEditedNodeGroup", entitytypeid, key, index);
                    var ret = null;
                    var list = this.getEditedBranch();
                    _.each(list.nodes(), function(node){
                    ...
                    console.log("getEditedNodeGroup *read* ret:", entitytypeid, key, ret);
                    return ret
                },
                write: function(value){
                    _.each(this.viewModel.branch_lists(), function(list){
        ...
        getBranchLists: function() {
            ...
            // console.log("branch_lists", branch_lists, branch_lists[0].nodes());
            return branch_lists;
        },
