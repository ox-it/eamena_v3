    ...
    $(document).ready(function() {
        ...
        var SearchView = Backbone.View.extend({
            ...
            initialize: function(options) {
                ...
                this.timeFilterText = this.timeFilter[0].$el.data().filtertext;
                ...
                this.searchQuery = {
                    queryString: function(){
                        ...
                        var params = {
                            ...
                            timeExpanded: self.timeFilter[1].expanded(),
            ...
            initializeSearchBoxes: function () {
                ...
                this.addTimeFilterEvents(this.timeFilterSimple, "_simple");
                // this.addTimeFilterEvents(this.timeFilterSimple, "_simple");
                ...
                for (var i = 0; i <= this.searchBoxes; i++) {
                    ...
                    this.addTimeFilterEvents(this.timeFilter[i], i);
                    // this.addTimeFilterEvents(this.timeFilter[i], i);
            ...
            addTimeFilter: function (i) {
                var newTimeFilter = new TimeFilter({
                    el: $.find('#time-filter-container-' + i)[0],
                    index: i
                });
            ...
            addTimeFilterEvents: function (timeFilter, i) {
                timeFilter.on('enabled', function(enabled, inverted){
                    if(enabled){
                        timeFilter.addTag(this.timeFilterText, inverted);
                        // this.termFilterSimple.addTag(this.timeFilterText, inverted);
                    }else{
                        timeFilter.removeTag(this.timeFilterText);
            ...
            onAddSearchBox: function (e) {
                ...
                this.addTimeFilterEvents (this.timeFilter[this.searchBoxes], this.searchBoxes);
