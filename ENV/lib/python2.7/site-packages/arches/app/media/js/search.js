    ...
    $(document).ready(function() {
        ...
        var SearchView = Backbone.View.extend({
            ...
            events: {
                ...
                'click .resource-type-item': 'onToggleResourceTypeItem',
            },
                ...
                this.searchQuery = {
                    queryString: function(){
                        ...
                        var params = {
                            ...
                            resourceTypes: ko.toJSON(self.resourceTypes),
            ...
            getSearchQuery: function(searchQuery){
                ...
                if('resourceTypes' in query){
                    this.onInitResourceTypes(JSON.parse(query.resourceTypes));
                    doQuery = true;
                }
            ...
            onInitResourceTypes: function (resourceTypes) {
                this.resourceTypes = resourceTypes;
                this.resourceTypes.forEach(function (rt) {
                    $(".resource-type-item[data-value='"+rt+"']").closest("li").addClass('select');
                })
            },
            
            onToggleResourceTypeItem: function (e) {
                e.preventDefault();
                var eIndex = this.resourceTypes.indexOf($(e.currentTarget).data().value);
                if (eIndex > -1) {
                    this.resourceTypes.splice(eIndex, 1);
                    $(e.target).closest("li").removeClass('select');
                } else {
                    this.resourceTypes.push($(e.currentTarget).data().value);
