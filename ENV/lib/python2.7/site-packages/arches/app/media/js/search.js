        ...
        var SearchView = Backbone.View.extend({
            ...
            getSearchQuery: function(){
                ...
                if('termFilterAndOr' in query){
                    _.each(JSON.parse(query.termFilterAndOr), function (groupingValue ,i) {
                        ...
                        this.termFilterAndOr[i] = groupingValue;
                    }.bind(this));
                    doQuery = true;
                }
                
                if('termFilterGroup' in query){
                    _.each(JSON.parse(query.termFilterGroup), function (groupingValue ,i) {
            ...
            onChangeTermAndOr: function (e) {
                ...
                if ($(e.target).hasClass("search-term-and")) {
                    if (termFilterAndOr != "and") {
                        $(e.target).closest(".dropdown").find(".term-and-or-value").html("And");
                        if (i == "_simple") {
                            this.termFilterAndOrSimple = "and";
                            this.termFilterSimple.termFilterAndOr = "and";
                        } else {
                            this.termFilterAndOr[i] = "and";
                            this.termFilter[i].termFilterAndOr = "and";
                        }
                        this.doQuery();
                    }
                } else if ($(e.target).hasClass("search-term-or")) {
                    if (termFilterAndOr != "or") {
                        $(e.target).closest(".dropdown").find(".term-and-or-value").html("Or");
                        if (i == "_simple") {
                            this.termFilterAndOrSimple = "or";
                            this.termFilterSimple.termFilterAndOr = "or";
                        } else {
                            this.termFilterAndOr[i] = "or";
                            this.termFilter[i].termFilterAndOr = "or";
                        }
                        this.doQuery();
                    }
                }
            ...
            initializeSearchBoxes: function () {
                ...
                this.termFilterAndOrSimple = "and";
                this.termFilterGroupSimple = "None";
            ...
            onAddSearchBox: function (e) {
                ...
                this.termFilterGroup[this.searchBoxes] = "None";
