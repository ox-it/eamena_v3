    ...
    $(document).ready(function() {
        ...
        var SearchView = Backbone.View.extend({
            ...
            events: {
                ...
                'click .toggle-related-resources': 'onChangeRelatedResources',
            ...
            doQuery: function () {
                ...
                if (this.searchRelatedResources) {
                    this.relatedResourcesQuery = queryString;
                } else {
                    this.resourcesQuery = queryString;
                }
            ...
            getQueryFromUrl: function (searchQuery) {
                var searchString = searchQuery ||location.search;
            ...
            getSearchQuery: function(searchQuery){
                ...
                console.log("getSearchQuery", query);
                if('page' in query){
                    ...
                    _.each(termFilterCombineWithPrev, function (value ,i) {
                        if (i == 0) {
                            ...
                            if (this.booleanSearch == 'and') {
                                buttonText = value ? 'Or' : 'And'
                            } else {
                                buttonText = value ? 'And' : 'Or'
                            }
                            this.termFilterCombineWithPrev[i] = value;
                            $(".select2-container.resource_search_widget"+i)
                                .closest(".search-box-container").find(".toggle-combine-prev").html(buttonText)
            ...
            onChangeAndOr: function (e) {
                ...
                _.each(this.termFilterCombineWithPrev, function (value ,i) {
                    if (i > 0) {
                        var buttonText;
                        if (this.booleanSearch == 'and') {
                            buttonText = value ? 'Or' : 'And'
            ...
            onChangeRelatedResources: function (e) {
                console.log("e", e);
                if (e.originalEvent) {
                    this.searchRelatedResources = !this.searchRelatedResources;
                    if (this.searchRelatedResources) {
                        $('.toggle-related-resources')
                        .removeClass('toggle-related-off').addClass('toggle-related-on btn-primary');
                        this.resourcesQuery = this.searchQuery.queryString();
                        this.getSearchQuery(this.relatedResourcesQuery);
                    } else {
                        $('.toggle-related-resources')
                        .removeClass('toggle-related-on btn-primary').addClass('toggle-related-off');
                        this.relatedResourcesQuery = this.searchQuery.queryString();
                        this.getSearchQuery(this.resourcesQuery);
                    }
                    console.log("this.resourcesQuery", this.resourcesQuery);
                    console.log("this.relatedResourcesQuery", this.relatedResourcesQuery);
                    this.doQuery();
                } else {
                    console.log("initial related resources values");
                }
            },
            ...
            onChangeCombineWithPrev: function (e) {
                ...
                if (i != "_simple") {
                    ...
                    if (this.booleanSearch == 'and') {
                        buttonText = this.termFilterCombineWithPrev[i] ? 'Or' : 'And'
                    } else {
                        buttonText = this.termFilterCombineWithPrev[i] ? 'And' : 'Or'
                    }
                    $(".select2-container.resource_search_widget"+i)
                        .closest(".search-box-container").find(".toggle-combine-prev").html(buttonText)
                        .removeClass(this.termFilterCombineWithPrev[i] ? 'toggle-combine-off' : 'toggle-combine-on btn-success')
            ...
            onAddSearchBox: function (e) {
                ...
                var buttonText = this.booleanSearch == 'and' ? 'And' : 'Or';
                $(".search-box-container[data-index='"+this.searchBoxes+"'] .toggle-combine-prev").html(buttonText);
                this.searchBoxes++;
            },
