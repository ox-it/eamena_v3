        ...
        var SearchView = Backbone.View.extend({
            ...
            onChangeTermAndOr: function (e) {
                ...
                if (i == "_simple") {
                    ...
                    var termFilterCombineWithPrev = this.termFilterCombineWithPrevSimple
                } else {
                    var termFilterAndOr = this.termFilterAndOr[i]
                    var termFilterCombineWithPrev = this.termFilterCombineWithPrev[i]
                }
                ...
                if (newValue != oldValue) {
                    ...
                    if (i == "_simple") {
                        ...
                        this.termFilterCombineWithPrev[i] = e.target.dataset.value;
            ...
            initializeSearchBoxes: function () {
                ...
                $(".toggle-combine-prev[data-index='0'] .term-and-or").hide();
                $(".toggle-combine-prev[data-index='_simple'] .term-and-or").hide();
            },
