...
class Concept(object):
    ...
    def get_parent_concept(cls, conceptvalueid):
        ...
        """
        member_relation = models.ConceptRelations.objects.get(conceptidto=conceptvalueid, relationtype="member")
        parent_concept = models.Concepts.objects.get(conceptid=member_relation.conceptidfrom)
