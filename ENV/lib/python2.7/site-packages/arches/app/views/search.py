...
def nested_query_from_pathed_values(pathed_values, stem):
    ...
    for leaf_group in leaf_groups:
        ...
        if leaf_group['term']['type'] == 'concept':
            ...
            boolfilter_folded.should(Match(field=stem+'.value', query=leaf_group['term']['value'], type='phrase_prefix'))
            boolfilter_folded.should(Match(field=stem+'.value.folded', query=leaf_group['term']['value'], type='phrase_prefix'))
            if leaf_group['term']['inverted']:
                bool_term.must_not(boolfilter_folded)
            else:    
                bool_term.must(boolfilter_folded)
