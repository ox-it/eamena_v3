            ...
            if groupid:
                ...
                for term in select_box:
                    ...
                    if term['type'] == 'concept':
                        ...
                        logging.warning("CONCEPT SCHEMA - %s", JSONSerializer().serialize(term_schema, indent=4))
                        term_path = term_schema['HERITAGE_RESOURCE_GROUP.E27']['steps']
                        ...
                        # logging.warning('GROUP_ID - %s', groupid)
                        # logging.warning('GROUP_SCHEMA - %s', JSONSerializer().serialize(term_schema, indent=4))
                        term_path = term_schema['HERITAGE_RESOURCE_GROUP.E27']['steps']
