...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        make_option('-o', '--operation', action='store', dest='operation', default='setup',
            type='choice', choices=['setup', 'install', 'setup_db', 'start_elasticsearch', 'setup_elasticsearch', 'build_permissions', 'livereload', 'load_resources', 'remove_resources', 'load_concept_scheme', 'index_database','reindex_maplayers','export_resource_graphs','export_resources','create_backlog', 'remove_resources_from_csv', 'legacy_fixer', 'load_relations', 'unload_relations', 'delete_indices'],
            help='Operation Type; ' +
    ...
    def handle(self, *args, **options):
        ...
        if options['operation'] == 'reindex_maplayers':
            self.reindex_maplayers(package_name)
    ...
    def reindex_maplayers(self, package_name):
        index_database.index_resources_into_map_layers()
