...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        ...
        make_option(None, '--oldtype', action='store', dest='old_entitytype', help="specify the old entity type when renaming entity types"),
        make_option(None, '--newtype', action='store', dest='new_entitytype', help="specify the new entity type when renaming entity types")
    )
    ...
    def handle(self, *args, **options):
        ...
        if options['operation'] == 'rename_entity_type':
            # print options
            migrate_resources.rename_entity_type(options['old_entitytype'], options['new_entitytype'])
